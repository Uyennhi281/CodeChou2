...
## In-game screens
################################################################################
# Define the list to store journal entries
default journal_entries = []

# Python function to add entries
init python:
    def add_entry(text):
        journal_entries.append(text)
...
screen journal():
    ...
    # Journal background
    add "journal.png" xalign 1.0 yalign 0.5

    # Scrollable viewport for entries
    viewport:
        xalign 0.95
        yalign 0.5
        xsize 300
...
screen inventory_screen():
    ...
    frame:
        xsize 1280  # Total width of the screen
        ysize 720   # Total height of the screen
        align (0.5, 0.2)
        background None
        ...
        hbox:
            ...
            # Items list section
            frame:
                background "#222"  # Background color for items list
                xminimum 550
                xmaximum 550
                ymaximum 680
                has vbox
                vbox:
                    spacing 15
                    text "Items" size 30 xalign 0.5 yalign 0.5
                    viewport:
                        draggable True
                        mousewheel True
                        vbox:
            ...
            # Description section
            frame:
                background "#333"  # Background color for description area
                xminimum 550
                xmaximum 550
                ymaximum 680
                has vbox
                vbox:
                    spacing 15
                    text "Description" size 30 xalign 0.5 yalign 0.5
                    if selected_item:
                        text selected_item['description'] xmaximum 530 line_spacing 1.2
                    else:
                        text "Select an item to see its description." xmaximum 530 line_spacing 1.2

            # Close button
            textbutton "Close" action Hide("inventory_screen") align (0.5, 1.0)
...
screen quick_menu():
    ...
    if quick_menu and not renpy.get_screen('choice'):
        ...
        imagebutton:
         ...
         xpos 760
         ypos 980
        textbutton "Inventory" action Show("inventory_screen") xpos 1000 ypos 980
        textbutton "Journal" action Show("journal") xpos 800 ypos 980
        hbox:
            style_prefix "quick"
